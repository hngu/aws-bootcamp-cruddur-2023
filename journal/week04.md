...
## Notes
- Create the rds instance in a region within your country
- RDS instance should not be public accessible
- security group rules define inbound/outbound communication
- for production you want it to be multi-AZ
- enable deletion protection
- Firewall rules: VPC security groups protect access to your RDS instance
- Use VPCs to to prevent unauthorized access
- Enable cloudtrail for RDS changes
- 
